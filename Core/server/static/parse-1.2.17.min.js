(function (e) {
    ...
    w.contains = w.include = function (e, t) {
        ...
        return x(e, function (e, r, s) {
            var a = t ? t.call(n, e, r, s) : e;
            i.computed > a && (i = {value: e, computed: a})
        }), i.value
    ...
    var C = function (e, t, n, i) {
        ...
        var a = 0, o = !0;
        if ("[object Array]" == r) {
            if (a = e.length, o = a == t.length)for (; a-- && (o = C(e[a], t[a], n, i)););
        } else {
            var u = e.constructor, l = t.constructor;
            if (u !== l && !(w.isFunction(u) && u instanceof u && w.isFunction(l) && l instanceof l))return!1;
            for (var h in e)if (w.has(e, h) && (a++, !(o = w.has(t, h) && C(e[h], t[h], n, i))))break;
            if (o) {
                for (h in t)if (w.has(t, h) && !a--)break;
                o = !a
            }
        }
    ...
    var I = {escape: RegExp("[" + w.keys(R.escape).join("") + "]", "g"), unescape: RegExp("(" + w.keys(R.unescape).join("|") + ")", "g")};
    ...
    w.template = function (e, t, n) {
        ...
        var r = RegExp([(n.escape || T).source, (n.interpolate || T).source, (n.evaluate || T).source].join("|") + "|$", "g"), s = 0, a = "__p+='";
    ...
    t.serverURL = "https://api.parse.com", "undefined" != typeof process && process.versions && process.versions.node && (t._isNode = !0), t.initialize = function (e, n, i) {
        ...
        return s.onload = function () {
            ...
            var e = {responseText: JSON.stringify({code: t.Error.X_DOMAIN_REQUEST, error: "IE's XDomainRequest does not supply error info."})};
            r.reject(e)
        ...
        if (e instanceof t.File) {
            ...
            return{__type: "File", name: e.name(), url: e.url()}
        }
        if (r.isObject(e)) {
            var s = {};
    ...
    e.Parse = e.Parse || {};
    var t = e.Parse, n = t._;
    t.Analytics = t.Analytics || {}, n.extend(t.Analytics, {track: function (e, i) {
        ...
        }), t._request({route: "events", className: e, method: "POST", data: {dimensions: i}})
    }})
}(this), function (e) {
    e.Parse = e.Parse || {};
    var t = e.Parse, n = t._;
    ...
    t.Events = {on: function (e, t, i) {
        var r, s, a, o, u;
        if (!t)return this;
        for (e = e.split(n), r = this._callbacks || (this._callbacks = {}), s = e.shift(); s;)u = r[s], a = u ? u.tail : {}, a.next = o = {}, a.context = i, a.callback = t, r[s] = {tail: o, next: u ? u.next : a}, s = e.shift();
        return this
    }, off: function (e, t, i) {
        var r, s, a, o, u, c;
    ...
    t.Op = function () {
    ...
    }), t.Op.Relation = t.Op._extend({_initialize: function (e, i) {
        ...
        return this.relationsToAdd.length > 0 && (s = n.map(this.relationsToAdd, r), e = {__op: "AddRelation", objects: s}), this.relationsToRemove.length > 0 && (s = n.map(this.relationsToRemove, r), t = {__op: "RemoveRelation", objects: s}), e && t ? {__op: "Batch", ops: [e, t]} : e || t || {}
    }, _mergeWithPrevious: function (e) {
        if (e) {
    ...
    }}), n.extend(t.Promise.prototype, {resolve: function () {
    ...
    t.File = function (e, i, o) {
        ...
        if (n.isArray(i))this._source = t.Promise.as(r(i), c); else if (i && i.base64) {
    ...
    }, t.File.prototype = {name: function () {
        return this._name
    }, url: function () {
        return this._url
    }, save: function (e) {
        ...
        return n._previousSave || (n._previousSave = n._source.then(function (i, r) {
            ...
            return t._request({route: "files", className: n._name, method: "POST", data: s, useMasterKey: e.useMasterKey})
        }).then(function (e) {
    ...
    t.Object = function (e, i) {
        ...
        if (r && (e = n.extend({}, r, e)), i && i.collection && (this.collection = i.collection), this._serverData = {}, this._opSetQueue = [
            {}
        ], this.attributes = {}, this._hashedJSON = {}, this._escapedAttributes = {}, this.cid = n.uniqueId("c"), this.changed = {}, this._silent = {}, this._pending = {}, !this.set(e, {silent: !0}))throw Error("Can't create an invalid Parse.Object");
        ...
        var r = function (e) {
            ...
            return e.length > 0 && (a = a.then(function () {
                return t._request({route: "batch", method: "POST", useMasterKey: i.useMasterKey, data: {requests: n.map(e, function (e) {
                    return{method: "DELETE", path: "/1/classes/" + e.className + "/" + e.id}
                })}})
            }).then(function (n) {
                t._arrayEach(e, function (e, a) {
                    if (n[a].success && i.wait)r(e); else if (n[a].error) {
        ...
        t._objectEach(e, function (e, i) {
            n[i] = t._decode(i, e)
        }), this._serverData = n, this._rebuildAllEstimatedData(), this._refreshCache(), this._opSetQueue = [
            {}
        ...
        this._opSetQueue = [
            {}
        ], this._mergeMagicFields(e), this._copyServerData(e), this._hasData = t
        ...
        if (!(!n.isObject(i) || i instanceof t.Object || i instanceof t.File)) {
            ...
            if (this._hashedJSON[e] !== r)return this._hashedJSON[e] = r, !0
        }
        return!1
        ...
        var n = this;
        e = e || {};
        var i = t._request({method: "GET", route: "classes", className: this.className, objectId: this.id, useMasterKey: e.useMasterKey});
        ...
        return t.Object._findUnsavedChildren(d.attributes, f, p), f.length + p.length > 0 ? t.Object._deepSaveAsync(this.attributes, {useMasterKey: o.useMasterKey}).then(function () {
            ...
            var c = t._request({route: r, className: u, objectId: d.id, method: e, useMasterKey: o.useMasterKey, data: i});
        ...
        if (!this.id)return i();
        e.wait || i();
        var r = t._request({route: "classes", className: this.className, objectId: this.id, method: "DELETE", useMasterKey: e.useMasterKey});
    ...
    e.Parse = e.Parse || {};
    var t = e.Parse, n = t._;
    t.Role = t.Object.extend("_Role", {constructor: function (e, i) {
    ...
    t.Collection = function (e, t) {
        ...
        }), this._reset(), this.add(e, {silent: !0, parse: n.parse}), n.silent || this.trigger("reset", this, n), this
    }, fetch: function (e) {
    ...
    e.Parse = e.Parse || {};
    var t = e.Parse, n = t._;
    t.User = t.Object.extend("_User", {_isCurrentUser: !1, _mergeFromObject: function (e) {
        ...
        var n = this;
        e = e || {};
        var i = t._request({route: "login", method: "GET", useMasterKey: e.useMasterKey, data: this.toJSON()});
        return i.then(function (e, t, i) {
            var r = n.parse(e, t, i);
    ...
    }}, {_currentUser: null, _currentUserMatchesDisk: !1, _CURRENT_USER_KEY: "currentUser", _authProviders: {}, _performUserRewrite: !0, signUp: function (e, n, i, r) {
        ...
        return t._request({route: "users", className: "me", method: "GET", useMasterKey: n.useMasterKey, sessionToken: e}).then(function (e, t, n) {
            var r = i.parse(e, t, n);
        ...
        n = n || {};
        var i = t._request({route: "requestPasswordReset", method: "POST", useMasterKey: n.useMasterKey, data: {email: e}});
    ...
    t.Query = function (e) {
    ...
    }, t.Query.prototype = {get: function (e, i) {
        var r = this;
        ...
        var i = this;
        e = e || {};
        var r = t._request({route: "classes", className: this.className, method: "GET", useMasterKey: e.useMasterKey, data: this.toJSON()});
        ...
        var i = this.toJSON();
        i.limit = 0, i.count = 1;
        var r = t._request({route: "classes", className: n.className, method: "GET", useMasterKey: e.useMasterKey, data: i});
        return r.then(function (e) {
            return e.count
        })._thenRunCallbacks(e)
    }, first: function (e) {
        ...
        var r = this.toJSON();
        r.limit = 1;
        var s = t._request({route: "classes", className: this.className, method: "GET", useMasterKey: e.useMasterKey, data: r});
        ...
        return i = i || {}, new t.Collection(e, n.extend(i, {model: this.objectClass, query: this}))
    }, skip: function (e) {
    ...
    e.Parse = e.Parse || {};
    var t, n, i = e.Parse, r = i._, s = !1, a = {authenticate: function (e) {
        var n = this;
        FB.login(function (t) {
            t.authResponse ? e.success && e.success(n, {id: t.authResponse.userID, access_token: t.authResponse.accessToken, expiration_date: new Date(1e3 * t.authResponse.expiresIn + (new Date).getTime()).toJSON()}) : e.error && e.error(n, t)
        }, {scope: t})
    }, restoreAuthentication: function (e) {
        if (e) {
            var t = {userID: e.id, accessToken: e.access_token, expiresIn: (i._parseDate(e.expiration_date).getTime() - (new Date).getTime()) / 1e3}, s = r.clone(n);
    ...
    i.FacebookUtils = {init: function (e) {
    ...
    e.Parse = e.Parse || {};
    var t = e.Parse, n = t._;
    t.Cloud = t.Cloud || {}, n.extend(t.Cloud, {run: function (e, n, i) {
        i = i || {};
        var r = t._request({route: "functions", className: e, method: "POST", useMasterKey: i.useMasterKey, data: t._encode(n, null, !0)});
        return r.then(function (e) {
    ...
    t.Installation = t.Object.extend("_Installation"), t.Push = t.Push || {}, t.Push.send = function (e, n) {
        ...
        var i = t._request({route: "push", method: "POST", data: e, useMasterKey: n.useMasterKey});
        return i._thenRunCallbacks(n)
    }
}(this);